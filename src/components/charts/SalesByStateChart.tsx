...
const COLORS = ["hsl(199, 89%, 48%)", "hsl(199, 89%, 55%)", "hsl(199, 89%, 62%)", "hsl(199, 89%, 69%)", "hsl(199, 89%, 76%)"];
const SalesByStateChart = ({
  data
}: SalesByStateChartProps) => {
  const chartData = data.slice(0, 10);
  return <div className="glass-card rounded-xl p-6 animate-slide-up" style={{
    animationDelay: "300ms"
  }}>
      <h3 className="text-lg font-semibold text-foreground mb-4">Vendas por Estado   </h3>
      <div className="h-80">
