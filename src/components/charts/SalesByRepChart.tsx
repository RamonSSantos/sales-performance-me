...
const SalesByRepChart = ({ data }: SalesByRepChartProps) => {
  return (
    <div className="glass-card rounded-xl p-6 animate-slide-up" style={{ animationDelay: "200ms" }}>
      <h3 className="text-lg font-semibold text-foreground mb-4">Sales by Representative</h3>
      <div className="h-80">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={data} layout="vertical" margin={{ top: 5, right: 30, left: 80, bottom: 5 }}>
            ...
            <Tooltip
              ...
              formatter={(value: number, name: string) => [formatCurrency(value), "Total Sales"]}
